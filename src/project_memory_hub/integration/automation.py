    ...
    def daily_reconcile(
        ...
        *,
        ...
        prompt = (
            ...
            "Report a bounded operational summary containing health, counts, blocked paths, and "
            "confirmation-queue size. For this automation, stage is `reconcile`. For any problem, "
            "report confirmed cause or not yet confirmed with bounded evidence, record state, "
            "code commit impact, safe remediation, and whether user action is required; an error "
            "code is evidence, not a root cause, and aggregate counts do not prove an individual "
            "record state. "
