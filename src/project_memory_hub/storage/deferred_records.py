...
class CodexDeferredLocator:
    ...
    def from_checkpoint(
        ...
        parser_policy_sha256 = cursor.get("parser_policy_sha256")
        ...
        if (
            not isinstance(parser_policy_sha256, str)
            or len(parser_policy_sha256) != 64
            or any(character not in "0123456789abcdef" for character in parser_policy_sha256)
        ):
            raise ValueError("deferred locator parser policy is invalid")
        return cls(
    ...
    def defer_on_connection(
        ...
        cursor = connection.execute(
            ...
            on conflict(
                ...
                parser_version, parser_policy_sha256, source_record_id
            ) do nothing
            """,
            (
                str(uuid4()).lower(),
...
def _stored_record(row: sqlite3.Row) -> CodexDeferredRecord:
    ...
    checkpoint = AdapterCheckpoint(
        ...
        cursor={
            ...
            "parser_policy_sha256": row["parser_policy_sha256"],
