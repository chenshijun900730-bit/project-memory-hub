    ...
    def __init__(
        ...
        *,
        ...
        if (
            ...
            or max_record_bytes >= max_read_bytes
            or max_runtime_scan_bytes < max_record_bytes
        ):
        ...
        try:
            ...
            try:
                ...
                if (
                    ...
                    or reopened_metadata.st_size != metadata.st_size
    ...
    def _parse_chunk(
        ...
        while cursor < len(data) and processed < self._max_records:
            ...
            if newline < 0:
                ...
                if fragment_bytes >= self._max_record_bytes:
        ...
        while read_offset < size:
            ...
            while True:
                ...
                if newline < 0:
                    break
                line_end = newline + 1
                if line_end - cursor > max_record_bytes:
                    raise CodexContextUnavailable("codex_context_unavailable")
...
def _runtime_model_from_lines(
    ...
    *,
    ...
    for raw_line in lines:
        ...
        if not raw_line.endswith(b"\n") or line_bytes > max_record_bytes:
            raise CodexContextUnavailable("codex_context_unavailable")
        try:
            value = json.loads(raw_line)
        except (ValueError, UnicodeDecodeError, RecursionError):
